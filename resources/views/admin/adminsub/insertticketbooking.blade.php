...
<div class="body" style="background-color:#77acf1;min-height:600px">
    <div class="container py-4">
        <form  class="form-text" action="/guest/send-email" method="POST">
            @csrf

            <h5 class="modal-title" id="exampleModalLabel">Pemesanan Tiket Baru</h5>
              <div class="modal-body container">
                ...
                <div class="col py-5">
                    <button type="submit" class="btn btn-outline-light" data-bs-toggle="modal"  data-bs-target="#exampleModal2"data-bs-dismiss="modal">Pesan</button>
                </div>
              </div>

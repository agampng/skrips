...
<div class="body" style="background-color:#77acf1;min-height:600px">
    <div class="container py-4">
        <form class="form-text" method="POST" action="/admin/updateticket" enctype="multipart/form-data">
            @csrf
            <div class="row g-0">
                <div class="col-3">
                    <h5>Perbarui Tiket</h5>
                </div>
                <div class="w-100"></div>
        ...
        if(scheduleID)
        {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    {
                        $("#ticket").empty();
                        $("#ticket").append('<option value="">Tidak Ada Tiket</option>');
                    }
                }
            });
        }

...
<div class="body" style="background-color:#77acf1;min-height:600px">
    <div class="container py-4">
        <form class="form-text" method="POST" action="/admin/updatecollection" enctype="multipart/form-data">
            @csrf
            <div class="row g-0">
                <div class="col-3">
                    <h5>Perbarui Koleksi</h3>
                </div>
                <div class="w-100"></div>
        ...
        if(collectionID)
        {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    {
                        $("#collection").empty();
                        $("#collection_image").append('<img src="" alt="Gambar Tidak Ditemukan" width="150">');
